"""
Django settings for game0verflows project.
...
SECRET_KEY = '!6g%9^r+rxid&m0f(2ygsjd*48f+70s6^z*m3rcbn(y=sihdyt'
...
ROOT_URLCONF = 'game0verflows.urls'
...
WSGI_APPLICATION = 'game0verflows.wsgi.application'
